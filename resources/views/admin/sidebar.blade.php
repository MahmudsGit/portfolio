<div class="main-sidebar sidebar-style-2">
  <aside id="sidebar-wrapper">
    <div class="sidebar-brand">
      <a class="h5" href="{{ url('/dashboard') }}">Golam <span class="text-primary">Mahmud</span></a>
    </div>
    <div class="sidebar-brand sidebar-brand-sm">
      <a class="h5" href="{{ url('/dashboard') }}">G<span class="text-primary">M</span></a>
    </div>
    <ul class="sidebar-menu">
      <li class="dropdown active">
        <a href="#" class="nav-link has-dropdown"><i class="fas fa-fire"></i><span>Dashboard</span></a>
        <ul class="dropdown-menu">
          <li><a class="nav-link beep beep-sidebar" target="_blank" href="{{ url('/') }}">View Site</a></li>
        </ul>
      </li>
